...
DARK_TEAM_LMNx9={
    ...
    "Developer": "Limon_Hossain",
    "Telegram": "t.me/DARK_TEAM_LMNx9"
    }
...
logo=(f"""
    {G}<\\> SPECIAL GIFT FOR 2k Subscriber\'s <\\>
\033[34;1m    ▛▀▖▞▀▖▞▀▖▌ ▌ ▙▄▌▛▀ ▞▀▖▙▗▌ ▌  ▙▗▌▙ ▌   ▞▀▖
    ▌ ▌▙▄▌▌ ▌▌▞   ▌ ▛▀ ▙▄▌▌▘▌ ▌  ▌▘▌▌▌▌▙▗▌▙▄▌
    ▌ ▌▌ ▌▌▀▖▌▀▖  ▌ ▙▄ ▌ ▌▌ ▌ ▌  ▌ ▌▌▝▌▞▀▖  ▌
    ▀▘ ▘ ▘▘ ▘▘ ▘  ▘ ▘  ▘ ▘▘ ▘ ▀▀ ▘ ▘▘ ▘▘ ▘ ▀
...
def bd():
        ...
        with tred(max_workers=30) as LimoN:    
            ...
            for psx in user:
                ...
                if mthd in ['1','01']:
                    LimoN.submit(rndm1,uid,passlist)
                if mthd in ['2','02']:
                    LimoN.submit(rndm2,uid,passlist)
                if mthd in ['3','03']:
                    LimoN.submit(rndm3,uid,passlist)
        print('\033[1;37m')
        print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        print(f'{B}\\{A}⚫{B}\\{G} THE PROCESS HAS COMPLETED')
